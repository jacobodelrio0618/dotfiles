...
return {
  ...
  s("\\bq", {
      ...
      i(2, "page"),                           -- Tabstop 2: Page/Postnote
      t("]{"),                                -- Separator
      i(1, "key"),                            -- Tabstop 1: Citation Key
      ...
      i(4),                                   -- Tabstop 4: Beside closing bracket
      t(" %"),                                -- Comment sign
      t({ "", "%", "" }),                   -- 5) New line + Comment
      i(0)
  }),
...
s("\\b1", {
  t({"",
    "%",
  "\\blockquote[{\\autocite["}), i(2), t("]{"),i(1),t("}}]%"),
  t({"",
     "{"}), i(3), 
  t({"}.",
     "%",
  ...
  s("\\cfr", {
    t({" %", 
       "\\autocite["}), i(1), t("]["), i(3), t("]{"), i(2), t("}"), i(4), t({"%", 
       ""}), i(0)
  }),

  s("\\ip", {
    t("\\InitPerson"), i(3), t("{"), i(1), t("}{"), i(2), t("}"), i(0),
  }),
  ...
  s("latin", {
    t("\\textlatin{\\textit{"), i(1), t("}}"), i(0),
  }),

  s("greek", {
    t("\\textgreek{"), i(1), t("}"), i(0),
  }),
 ...
 s("subfile", {
    t({
      "% !TEX root = ..\\..\\main.tex",
      "% NOTICE. RESTART NEOVIM AFTER FIRST WRITE FOR ROOT COMPILATION.",
...
s("\\fb", {
  ...
  s("h", {
    t("\\hypo{"), i(1, "Label"), t("}{"), i(2, "Formula"), t("}"),
    i(0),
  }),

  s("j", {
    t("\\have{"), i(1, "Label"), t("}{"), i(2, "Formula"), t("}"),
    i(0),
  }),
  ...
  s("sh", {
    t("\\hypo{"), i(1, "Formula"), t({"}%", ""}),
    i(0),
  }),

  s("sj", {
    t("\\infer"), i(1, "From"), t("[$"), i(2, "Rule"), t("$]{"), i(3, "Formula"), t({"}%", ""}),
    i(0),
  }),
...
s("aproof", {
  ...
  s("aj", {
    i(0),
    t({"", "\\hypo{\\begin{gathered} "}), i(1, "Formula"), t({" \\\\", "    "}), i(2, "Status"),
    t({"", "\\end{gathered}}%"}),
  }),

  s("ah", {
    i(0),t({"",
    "\\infer"}), i(1, "Branching"), t("[$"), i(2, "Rule"), t("$]{"), i(3, "Formula"), t("}%"),
  }),
  ...
  s("tree", {
    ...
    t({"    ["}), t("$ "), i(1, "Formula"), t({" $%"}),
    t({"    [\\langle "}), i(2, "Rule"), t({" \\rangle $"}), i(0), t({"]", "    %", "    \\end{forest}", "\\end{center}"}),
  }),

  s("sbranch", {
    t({"", "    %"}),
    t({"    ["}), t("$ "), i(1, "Formula"), t({" $%"}),
    t({"    [\\langle "}), i(2, "Rule"), t({" \\rangle $"}), i(0), t({"]"}),
  }),
  ...
  s("str", {
    t("[\\stac\\rel{"), i(1, "x"), t("}{_{"), i(2, "t"), t("}}]"), i(0),
  }),
